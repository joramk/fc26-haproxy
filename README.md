# Fedora 26 HAProxy docker image with Let´s Encrypt [![Build Status](https://travis-ci.org/joramk/fc26-haproxy.svg?branch=haproxy-1.7.3)](https://travis-ci.org/joramk/fc26-haproxy)
...
~~~
docker run joramk/fc26-haproxy:1.7.3
~~~
...
## docker ps on successful start
    ...
    c2c6dc6cd27f        joramk/fc26-haproxy:1.7.3   "/docker-entrypoin..."   31 seconds ago      Up 30 seconds (healthy)   80/tcp, 443/tcp     fc26_haproxy
